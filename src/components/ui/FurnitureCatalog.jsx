...
export function FurnitureCatalog() {
  const { addItemAt, setDraggingCatalogItem, setDragHoverPoint } = useRoom();
  ...
  return (
    <div className="absolute top-20 right-4 bottom-20 z-20 flex pointer-events-auto select-none">
